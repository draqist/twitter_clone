...
const TweetInput = () => {
  return (
    <HStack spacing='12px' color='white' fontSize='1rem' borderBottom='1px solid #2F3336' px='1rem' py='12px' alignItems='flex-start'>
      ...
      <Box w='100%'>
        <Box>
          <Textarea variant='flushed' borderColor='transparent'  placeholder='What&apos;s happening?' pb='20px'/>
        </Box>
        <Flex justifyContent='space-between' alignItems='center' mt='20px'>
          ...
          <Button colorScheme='twitter' borderRadius='2.25rem' w='80px' > Tweet </Button>
        </Flex>
      </Box>
    </HStack>
  )
